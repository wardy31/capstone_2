<template>
        ...
        <v-container>
          <v-card class="rounded-lg elevation-6 accent mx-auto my-auto" width="800">
            <v-card-title class="primary--text"
              ><h3>Create Account</h3></v-card-title
            >
            <h5 class="mx-4 mb-8 secondary--text">* User Registration.</h5>
            <div class="mx-16">
              ...
              <v-row dense>
                <v-col
                  ><v-text-field label="Department" v-model="clinic.department" filled dense outlined></v-text-field
                ></v-col>
                <v-col
                  > <v-select
              ...
              <v-row dense>
                ...
                <v-col
                  > <v-select
                      :items="['Partially Vaccinated','Fully Vaccinated','Booster']"
            ...
            <v-card-actions
              >
              <v-spacer></v-spacer>
              <v-btn text plain to="user-login" class=" text-capitalize">Cancel</v-btn>
              <v-btn color="primary" @click="submit" :loading="loading" class="pa-5 px-12 text-capitalize">Create Account</v-btn>
              </v-card-actions>
          </v-card>
        </v-container>
      </v-main>
  ...
  export default {
    ...
    methods:{
      submit(){
          this.$store.dispatch('register/createUser',this.clinic)
      }
    }
  };
  </script>
